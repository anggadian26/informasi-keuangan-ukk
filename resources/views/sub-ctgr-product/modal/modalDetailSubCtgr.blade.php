<div class="modal fade" id="detailSubCtgrProduct{{ $i->sub_ctgr_product_id }}" tabindex="-1" aria-hidden="true">
            ...
            <form action="#" method="POST">
                ...
                <div class="modal-body">
                    <div class="row justify-content-start mb-3">
                        <label class="col-sm-3 col-form-label text-start" for="basic-default-name">Kode Sub Kategori Produk</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row justify-content-start mb-3">
                        <label class="col-sm-3 col-form-label text-start" for="basic-default-name">Nama Sub Kategori Produk</label>
                        <div class="col-sm-9">
                            <input type="text" name="" class="form-control" id="basic-default-name"
